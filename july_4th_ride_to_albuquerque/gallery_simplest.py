...
@media only screen and (min-width: 1024px) {
  .photos div:nth-child(4n+0) {
    width: 380px;
  }
  .photos div:nth-child(4n+1) {
    width: 250px;
  }
  .photos div:nth-child(4n+2) {
    width: 325px;
  }
  .photos div:nth-child(4n+3) {
    width: 180px;
  }
}
...
#        cmd = ['convert', '-auto-orient', '-define', 'registry:temporary-path=/home/abf/tmp', image_path, '-quality', '85', '-thumbnail', '%(edge)sx%(edge)s>' % { 'edge': args.thumbnail_long_edge }, thumbnail_path]
        ...
        if video:
            cmd = ['composite', '-gravity', 'center', '../play.png', thumbnail_path, thumbnail_path]
